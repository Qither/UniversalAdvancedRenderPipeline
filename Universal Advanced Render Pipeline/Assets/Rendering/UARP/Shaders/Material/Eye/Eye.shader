Shader "UARP/Eye"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #pragma fragment EyePassFragment
            ...
            #include "Assets/Rendering/UARP/Shaders/Material/Eye/EyeInput.hlsl"
            #include "Assets/Rendering/UARP/Shaders/Material/Eye/EyeLighting.hlsl"
            #include "Assets/Rendering/UARP/Shaders/Material/Common/Passes/Renderer/Vertex/Forward/SimpleLitForwardVertex.hlsl"
            #include "Assets/Rendering/UARP/Shaders/Material/Common/Passes/Renderer/Fragment/Forward/EyeForwardFragment.hlsl"
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            // Includes
            #include "Assets/Rendering/UARP/Shaders/Material/Eye/EyeInput.hlsl"
            #include "Assets/Rendering/UARP/Shaders/Material/Common/Passes/ShadowCaster/Vertex/ShadowCasterVertex.hlsl"
        ...
        Pass
        {
            ...
            // -------------------------------------
            // Shader Stages
            #pragma vertex SimpleLitGBufferPassVertex
            #pragma fragment EyeGBufferPassFragment
            ...
            #include "Assets/Rendering/UARP/Shaders/Material/Eye/EyeInput.hlsl"
            #include "Assets/Rendering/UARP/Shaders/Material/Eye/EyeLighting.hlsl"
            #include "Assets/Rendering/UARP/Shaders/Material/Common/Passes/Renderer/Vertex/Deferred/SimpleLitDeferredVertex.hlsl"
            #include "Assets/Rendering/UARP/Shaders/Material/Common/Passes/Renderer/Fragment/Deferred/EyeDeferredFragment.hlsl"
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            // Includes
            #include "Assets/Rendering/UARP/Shaders/Material/Eye/EyeInput.hlsl"
            #include "Assets/Rendering/UARP/Shaders/Material/Common/Passes/DepthOnly/Vertex/DepthOnlyVertex.hlsl"
        ...
        Pass
        {
            ...
            #pragma fragment EyeDepthNormalsFragment
            ...
            // Includes
            #include "Assets/Rendering/UARP/Shaders/Material/Eye/EyeInput.hlsl"
            #include "Assets/Rendering/UARP/Shaders/Material/Common/Passes/DepthNormals/Vertex/DepthNormalsVertex.hlsl"
            #include "Assets/Rendering/UARP/Shaders/Material/Common/Passes/DepthNormals/Fragment/EyeDepthNormalsFragment.hlsl"
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            #include "Assets/Rendering/UARP/Shaders/Material/Eye/EyeInput.hlsl"
            #include "Assets/Rendering/UARP/Shaders/Material/Eye/EyeLighting.hlsl"
            #include "Assets/Rendering/UARP/Shaders/Material/Common/Passes/Meta/Vertex/MetaVertex.hlsl"
