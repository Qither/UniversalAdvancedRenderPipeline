Shader "UARP/ComplexLit"
{
    Properties
    {
        ...
        [HideInInspector] _DiffusionLUT("Obsolete SSS LUT", 2D) = "grey" {}
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            // -------------------------------------
            // Shader Stages
            #pragma vertex ComplexLitPassVertex
            ...
            #include "Assets/Rendering/UARP/Shaders/Material/ComplexLit/ComplexLitInput.hlsl"
            #include "Assets/Rendering/UARP/Shaders/Material/Common/Lighting/LitLighting.hlsl"
            #include "Assets/Rendering/UARP/Shaders/Material/Common/Passes/Renderer/Vertex/Forward/ComplexLitForwardVertex.hlsl"
            #include "Assets/Rendering/UARP/Shaders/Material/Common/Passes/Renderer/Fragment/Forward/ComplexLitForwardFragment.hlsl"
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            // -------------------------------------
            // Shader Stages
            #pragma vertex ComplexLitGBufferPassVertex
            #pragma fragment ComplexLitGBufferPassFragment
            ...
            #include "Assets/Rendering/UARP/Shaders/Material/ComplexLit/ComplexLitInput.hlsl"
            #include "Assets/Rendering/UARP/Shaders/Material/Common/Lighting/LitLighting.hlsl"
            #include "Assets/Rendering/UARP/Shaders/Material/Common/Passes/Renderer/Vertex/Deferred/ComplexLitDeferredVertex.hlsl"
            #include "Assets/Rendering/UARP/Shaders/Material/Common/Passes/Renderer/Fragment/Deferred/ComplexLitDeferredFragment.hlsl"
            ENDHLSL
        }
