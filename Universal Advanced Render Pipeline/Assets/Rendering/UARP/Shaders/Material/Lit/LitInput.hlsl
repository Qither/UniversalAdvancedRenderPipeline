...
#include "Assets/Rendering/UARP/Shaders/Material/Lit/LitProperties.hlsl"
#include "Assets/Rendering/UARP/Shaders/Material/Lit/LitMaps.hlsl"
...
#if defined(_NORMAL) || defined(_DOUBLESIDED_ON) || defined(_PIXEL_DISPLACEMENT)
