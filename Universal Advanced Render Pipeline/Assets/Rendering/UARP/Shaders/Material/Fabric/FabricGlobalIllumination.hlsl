#ifndef URPPLUS_GLOBAL_ILLUMINATION_INCLUDED
#define URPPLUS_GLOBAL_ILLUMINATION_INCLUDED

#include "Assets/Rendering/UARP/Shaders/Material/Common/BRDF/EnviromentBRDF.hlsl"
#include "Packages/com.unity.render-pipelines.universal/ShaderLibrary/GlobalIllumination.hlsl"
#include "Assets/Rendering/UARP/Shaders/Material/Common/GlobalIllumination/SpecularOcclusion.hlsl"
...
{
    half perceptualRoughness = brdfData.perceptualRoughness;
    #ifdef _MATERIAL_FEATURE_SHEEN
        perceptualRoughness= 0.0h;
    #endif
    
    half3 reflectVector = AnisotropyReflectVector(vData, perceptualRoughness, surfaceData.anisotropy);
    half NoV = saturate(dot(vData.normalWS, vData.viewDirectionWS));
    half fresnelTerm = Pow4(1.0 - NoV);

    half3 indirectDiffuse = bakedGI;
    half3 indirectSpecular = GlossyEnvironmentReflection(reflectVector, positionWS, perceptualRoughness, 1.0, normalizedScreenSpaceUV);
