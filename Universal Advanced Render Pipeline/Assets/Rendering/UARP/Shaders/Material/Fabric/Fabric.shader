Shader "UARP/Fabric"
{
    Properties
    {
        ...
        _ThicknessCurvatureRemap("Thickness Remap", Vector) = (0, 1, 0, 0)
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #define FOR_SPECULAR_MODE_SNOW 1
            #include "Assets/Rendering/UARP/Shaders/Material/Fabric/FabricInput.hlsl"
            #include "Assets/Rendering/UARP/Shaders/Material/Fabric/FabricLighting.hlsl"
            #include "Assets/Rendering/UARP/Shaders/Material/Common/Passes/Renderer/Vertex/Forward/LitForwardVertex.hlsl"
            #include "Assets/Rendering/UARP/Shaders/Material/Common/Passes/Renderer/Fragment/Forward/FabricForwardFragment.hlsl"
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            #include "Assets/Rendering/UARP/Shaders/Material/Fabric/FabricInput.hlsl"
            #include "Assets/Rendering/UARP/Shaders/Material/Fabric/FabricLighting.hlsl"
            #include "Assets/Rendering/UARP/Shaders/Material/Common/Passes/Renderer/Vertex/Deferred/LitDeferredVertex.hlsl"
            #include "Assets/Rendering/UARP/Shaders/Material/Common/Passes/Renderer/Fragment/Deferred/FabricDeferredFragment.hlsl"
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            // Includes
            #include "Assets/Rendering/UARP/Shaders/Material/Fabric/FabricInput.hlsl"
            #include "Assets/Rendering/UARP/Shaders/Material/Common/Passes/DepthNormals/FabricDepthNormals.hlsl"
