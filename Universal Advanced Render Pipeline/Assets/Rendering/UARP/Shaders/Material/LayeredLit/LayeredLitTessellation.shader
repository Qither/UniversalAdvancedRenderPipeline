Shader "UARP/LayeredLitTessellation"
{
    Properties
    {
        ///////////////////////////////////////
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            // -------------------------------------
            // Shader Stages
            #pragma vertex LayeredLitPassVertex
            #pragma hull Hull
            #pragma domain Domain
            #pragma fragment LayeredLitPassFragment
            ...
            #include "Assets/Rendering/UARP/Shaders/Material/LayeredLit/LayeredLitInput.hlsl"
            #include "Assets/Rendering/UARP/Shaders/Material/Common/Lighting/LitLighting.hlsl"
            #include "Assets/Rendering/UARP/Shaders/Material/Common/Passes/Renderer/Vertex/Forward/Tesellation/LayeredLitForwardTessellationVertex.hlsl"
            #include "Assets/Rendering/UARP/Shaders/Material/Common/Passes/Renderer/Fragment/Forward/LayeredLitForwardFragment.hlsl"
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            // -------------------------------------
            // Shader Stages
            #pragma vertex LayeredShadowPassVertex
            #pragma hull Hull
            #pragma domain LayeredShadowDomain
            #pragma fragment LayeredShadowPassFragment
            ...
            // Includes
            #include "Assets/Rendering/UARP/Shaders/Material/LayeredLit/LayeredLitInput.hlsl"
            #include "Assets/Rendering/UARP/Shaders/Material/Common/Passes/ShadowCaster/Vertex/LayeredShadowCasterTessellationVertex.hlsl"
            #include "Assets/Rendering/UARP/Shaders/Material/Common/Passes/ShadowCaster/Fragment/LayeredShadowCasterFragment.hlsl"
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            // -------------------------------------
            // Shader Stages
            #pragma vertex LayeredLitGBufferPassVertex
            #pragma hull Hull
            #pragma domain Domain
            #pragma fragment LayeredLitGBufferPassFragment
            ...
            #include "Assets/Rendering/UARP/Shaders/Material/LayeredLit/LayeredLitInput.hlsl"
            #include "Assets/Rendering/UARP/Shaders/Material/Common/Lighting/LitLighting.hlsl"
            #include "Assets/Rendering/UARP/Shaders/Material/Common/Passes/Renderer/Vertex/Deferred/Tessellation/LayeredLitDeferredTessellationVertex.hlsl"
            #include "Assets/Rendering/UARP/Shaders/Material/Common/Passes/Renderer/Fragment/Deferred/LayeredLitDeferredFragment.hlsl"
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            // -------------------------------------
            // Shader Stages
            #pragma vertex LayeredDepthOnlyVertex
            #pragma hull Hull
            #pragma domain LayeredDepthDomain
            #pragma fragment LayeredDepthOnlyFragment
            ...
            // Includes
            #include "Assets/Rendering/UARP/Shaders/Material/LayeredLit/LayeredLitInput.hlsl"
            #include "Assets/Rendering/UARP/Shaders/Material/Common/Passes/DepthOnly/Vertex/LayeredDepthOnlyTessellationVertex.hlsl"
            #include "Assets/Rendering/UARP/Shaders/Material/Common/Passes/DepthOnly/Fragment/LayeredDepthOnlyFragment.hlsl"
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            // -------------------------------------
            // Shader Stages
            #pragma vertex LayeredDepthNormalsVertex
            #pragma hull Hull
            #pragma domain LayeredDepthNormalsDomain
            #pragma fragment LayeredDepthNormalsFragment
            ...
            // Includes
            #include "Assets/Rendering/UARP/Shaders/Material/LayeredLit/LayeredLitInput.hlsl"
            #include "Assets/Rendering/UARP/Shaders/Material/Common/Passes/DepthNormals/LayeredLitDepthNormals.hlsl"
            #include "Assets/Rendering/UARP/Shaders/Material/Common/Passes/DepthNormals/Vertex/LayeredDepthNormalsTessellationVertex.hlsl"
            #include "Assets/Rendering/UARP/Shaders/Material/Common/Passes/DepthNormals/Fragment/LayeredDepthNormalsFragment.hlsl"
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            #pragma hull Hull
            #pragma domain LayeredMetaDomain
            ...
            #include "Assets/Rendering/UARP/Shaders/Material/LayeredLit/LayeredLitInput.hlsl"
            #include "Assets/Rendering/UARP/Shaders/Material/Common/Lighting/LitLighting.hlsl"
            #include "Assets/Rendering/UARP/Shaders/Material/Common/Passes/Meta/Vertex/LayeredMetaTessellationVertex.hlsl"
            #include "Assets/Rendering/UARP/Shaders/Material/Common/Passes/Meta/Fragment/LayeredMetaFragment.hlsl"
