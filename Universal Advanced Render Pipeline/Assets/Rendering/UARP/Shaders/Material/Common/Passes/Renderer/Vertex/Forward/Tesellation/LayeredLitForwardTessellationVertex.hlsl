#ifndef URPPLUS_FORWARD_LAYERER_LIT_TESSELLATION_VERTEX_INCLUDED
#define URPPLUS_FORWARD_LAYERER_LIT_TESSELLATION_VERTEX_INCLUDED
...
TessellationControlPoint LayeredLitPassVertex(Attributes input)
{
