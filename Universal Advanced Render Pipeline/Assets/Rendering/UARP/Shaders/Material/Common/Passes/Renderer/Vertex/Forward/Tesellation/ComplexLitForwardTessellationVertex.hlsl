#ifndef URPPLUS_FORWARD_COMPLEX_LIT_TESELLATION_VERTEX_INCLUDED
#define URPPLUS_FORWARD_COMPLEX_LIT_TESELLATION_VERTEX_INCLUDED
...
TessellationControlPoint ComplexLitPassVertex(Attributes input)
{
