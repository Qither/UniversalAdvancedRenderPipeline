#ifndef URPPLUS_LAYERED_DEPTH_ONLY_TESSELLATION_VERTEX_INCLUDED
#define URPPLUS_LAYERED_DEPTH_ONLY_TESSELLATION_VERTEX_INCLUDED
...
TessellationControlPoint LayeredDepthOnlyVertex(Attributes input)
{
...
[domain("tri")]
Varyings LayeredDepthDomain(TessellationFactors tessFactors, const OutputPatch<TessellationControlPoint, 3> input, float3 baryCoords : SV_DomainLocation)
{
