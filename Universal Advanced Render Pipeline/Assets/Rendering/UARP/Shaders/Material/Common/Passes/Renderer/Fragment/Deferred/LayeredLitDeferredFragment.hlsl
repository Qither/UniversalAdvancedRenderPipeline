#ifndef URPPLUS_DEFERRED_LAYERER_LIT_FRAGMENT_INCLUDED
#define URPPLUS_DEFERRED_LAYERER_LIT_FRAGMENT_INCLUDED
...
FragmentOutput LayeredLitGBufferPassFragment(
    Varyings input
    , half faceSign : VFACE
