#ifndef URPPLUS_DEPTH_NORMALS_TESSELLATION_VERTEX_INCLUDED
#define URPPLUS_DEPTH_NORMALS_TESSELLATION_VERTEX_INCLUDED
...
Varyings DepthNormalsDomain(TessellationFactors tessFactors, const OutputPatch<TessellationControlPoint, 3> input, float3 baryCoords : SV_DomainLocation)
{
    ...
    real3 positionWS = ApplyVertexDisplacementWS(data.positionOS.xyz, normalInput.normalWS, output.uv);
