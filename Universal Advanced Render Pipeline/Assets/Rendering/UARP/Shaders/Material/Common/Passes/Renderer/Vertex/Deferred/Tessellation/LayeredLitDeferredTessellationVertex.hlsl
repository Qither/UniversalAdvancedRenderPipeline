#ifndef URPPLUS_DEFERRED_LAYERER_LIT_TESSELLATION_VERTEX_INCLUDED
#define URPPLUS_DEFERRED_LAYERER_LIT_TESSELLATION_VERTEX_INCLUDED
...
TessellationControlPoint LayeredLitGBufferPassVertex(Attributes input)
{
...
Varyings Domain(TessellationFactors tessFactors, const OutputPatch<TessellationControlPoint, 3> input, float3 baryCoords : SV_DomainLocation)
{
    ...
    VertexPositionInputs vertexInput = CalculateVertexPositionInputs(vertexColor, data.positionOS.xyz, normalInput.normalWS, output.uv);
