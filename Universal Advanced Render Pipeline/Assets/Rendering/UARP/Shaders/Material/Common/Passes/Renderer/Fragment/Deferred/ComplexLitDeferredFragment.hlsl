#ifndef URPPLUS_DEFERRED_COMPLEX_LIT_FRAGMENT_INCLUDED
#define URPPLUS_DEFERRED_COMPLEX_LIT_FRAGMENT_INCLUDED
...
FragmentOutput ComplexLitGBufferPassFragment(
    Varyings input
    , half faceSign : VFACE
