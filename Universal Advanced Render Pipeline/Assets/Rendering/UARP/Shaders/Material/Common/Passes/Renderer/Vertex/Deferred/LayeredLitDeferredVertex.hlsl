#ifndef URPPLUS_DEFERRED_LAYERED_LIT_VERTEX_INCLUDED
#define URPPLUS_DEFERRED_LAYERED_LIT_VERTEX_INCLUDED
...
Varyings LayeredLitGBufferPassVertex(Attributes input)
{
    ...
    VertexPositionInputs vertexInput = CalculateVertexPositionInputs(vertexColor, input.positionOS.xyz, normalInput.normalWS, output.uv);
