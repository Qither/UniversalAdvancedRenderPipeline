...
UNITY_DOTS_INSTANCING_START(MaterialPropertyMetadata)
    ...
    UNITY_DOTS_INSTANCED_PROP(float , _SubsurfaceMask)
    UNITY_DOTS_INSTANCED_PROP(float , _TransmissionMask)
...
static float  unity_DOTS_Sampled_SubsurfaceMask;
static float  unity_DOTS_Sampled_TransmissionMask;
static float  unity_DOTS_Sampled_Thickness;
static float  unity_DOTS_Sampled_DiffusionProfileHash;

void SetupDOTSSSSLitMaterialPropertyCaches()
{
    ...
    unity_DOTS_Sampled_SubsurfaceMask       = UNITY_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float , _SubsurfaceMask);
    unity_DOTS_Sampled_TransmissionMask     = UNITY_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float , _TransmissionMask);
...
#define UNITY_SETUP_DOTS_MATERIAL_PROPERTY_CACHES() SetupDOTSSSSLitMaterialPropertyCaches()
...
#define _SubsurfaceMask         unity_DOTS_Sampled_SubsurfaceMask
#define _TransmissionMask       unity_DOTS_Sampled_TransmissionMask
...
half SampleSubsurfaceMask(float2 uv)
{
    ...
    half maskFromMap = SAMPLE_TEXTURE2D(_SubsurfaceMaskMap, sampler_SubsurfaceMaskMap, uv).r;
    return maskFromMap * _SubsurfaceMask;
#else
    return _SubsurfaceMask;
#endif
}
